...
#define IUCLC   0x2000
#define IGNPAR  0x4000 /* ignore chars with parity errors */
...
/*
 * Baud-rate constants (c_cflag / cfsetspeed).  Standard encoding: the low
 * rates are small integers, the extended rates carry the CBAUDEX bit.  These
 * are the tokens terminal software (ssh, stty, getty) expects to exist even
 * when the underlying line is a pty with no real bit rate.
 */
#define B0        0000000
#define B50       0000001
#define B75       0000002
