...
void *memset(void *s, int c, size_t n)
{
	...
	__asm__ volatile("rep stosb" : "+D"(s), "+c"(n) : "a"(val) : "memory");
	return ret;
}
...
char *strsignal(int sig)
{
	...
	case 7:
		...
		break;
	case 8:
		m = "Floating point exception";
		break;
	case 9:
		m = "Killed";
		break;
	case 10:
		m = "User defined signal 1";
		break;
	case 11:
		m = "Segmentation fault";
		break;
	case 12:
		m = "User defined signal 2";
		break;
	case 13:
		m = "Broken pipe";
		break;
	...
	case 21:
		...
		break;
	case 22:
		m = "Stopped (tty output)";
		break;
	case 23:
		m = "Urgent I/O condition";
		break;
	case 24:
		m = "CPU time limit exceeded";
		break;
	case 25:
		m = "File size limit exceeded";
		break;
	case 26:
		m = "Virtual timer expired";
		break;
	case 27:
		m = "Profiling timer expired";
		break;
	case 28:
		m = "Window changed";
		break;
