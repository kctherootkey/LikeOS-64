...
static const struct {
	...
	{ 5, "TRAP" },    { 6, "ABRT" },  { 6, "IOT" },     { 7, "BUS" },
	{ 8, "FPE" },     { 9, "KILL" },  { 10, "USR1" },   { 11, "SEGV" },
	{ 12, "USR2" },   { 13, "PIPE" }, { 14, "ALRM" },   { 15, "TERM" },
	{ 16, "STKFLT" }, { 17, "CHLD" }, { 18, "CONT" },   { 19, "STOP" },
	{ 20, "TSTP" },   { 21, "TTIN" }, { 22, "TTOU" },   { 23, "URG" },
	{ 24, "XCPU" },   { 25, "XFSZ" }, { 26, "VTALRM" }, { 27, "PROF" },
	{ 28, "WINCH" },  { 29, "IO" },   { 29, "POLL" },   { 30, "PWR" },
	{ 31, "SYS" },    { 0, NULL }
};
...
int main(int argc, char **argv)
{
	...
	while (i < argc) {
		...
		if (*end != '\0') {
			fprintf(stderr,
				"kill: %s: arguments must be process or job IDs\n",
				argv[i]);
			ret = 1;
			i++;
			continue;
