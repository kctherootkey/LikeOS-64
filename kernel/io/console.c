...
// Forward declaration
static int kvprintf_to_buffer(const char *format, va_list args,
			      string_buffer_t *sb);
...
static const uint8_t font_8x16[128][16] = {
	...
	// Numbers
	['0'] = { 0x00, 0x00, 0x3C, 0x66, 0x6E, 0x76, 0x66, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['1'] = { 0x00, 0x00, 0x18, 0x18, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x7E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['2'] = { 0x00, 0x00, 0x3C, 0x66, 0x06, 0x0C, 0x30, 0x60, 0x60, 0x60,
		  0x7E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['3'] = { 0x00, 0x00, 0x3C, 0x66, 0x06, 0x06, 0x1C, 0x06, 0x06, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['4'] = { 0x00, 0x00, 0x06, 0x0E, 0x1E, 0x66, 0x66, 0x7F, 0x06, 0x06,
		  0x06, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['5'] = { 0x00, 0x00, 0x7E, 0x60, 0x60, 0x7C, 0x06, 0x06, 0x06, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['6'] = { 0x00, 0x00, 0x3C, 0x66, 0x60, 0x60, 0x7C, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['7'] = { 0x00, 0x00, 0x7E, 0x66, 0x0C, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['8'] = { 0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['9'] = { 0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3E, 0x06, 0x06, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },

	// Uppercase Letters
	['A'] = { 0x00, 0x00, 0x18, 0x3C, 0x66, 0x66, 0x7E, 0x66, 0x66, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['B'] = { 0x00, 0x00, 0x7C, 0x66, 0x66, 0x7C, 0x7C, 0x66, 0x66, 0x66,
		  0x7C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['C'] = { 0x00, 0x00, 0x3C, 0x66, 0x60, 0x60, 0x60, 0x60, 0x60, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['D'] = { 0x00, 0x00, 0x78, 0x6C, 0x66, 0x66, 0x66, 0x66, 0x66, 0x6C,
		  0x78, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['E'] = { 0x00, 0x00, 0x7E, 0x60, 0x60, 0x78, 0x78, 0x60, 0x60, 0x60,
		  0x7E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['F'] = { 0x00, 0x00, 0x7E, 0x60, 0x60, 0x78, 0x78, 0x60, 0x60, 0x60,
		  0x60, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['G'] = { 0x00, 0x00, 0x3C, 0x66, 0x60, 0x60, 0x6E, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['H'] = { 0x00, 0x00, 0x66, 0x66, 0x66, 0x7E, 0x7E, 0x66, 0x66, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['I'] = { 0x00, 0x00, 0x3C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['J'] = { 0x00, 0x00, 0x1E, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x6C, 0x6C,
		  0x38, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['K'] = { 0x00, 0x00, 0x66, 0x6C, 0x78, 0x70, 0x70, 0x78, 0x6C, 0x66,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['L'] = { 0x00, 0x00, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60,
		  0x7E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['M'] = { 0x00, 0x00, 0x63, 0x77, 0x7F, 0x6B, 0x63, 0x63, 0x63, 0x63,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['N'] = { 0x00, 0x00, 0x66, 0x76, 0x7E, 0x7E, 0x6E, 0x66, 0x66, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['O'] = { 0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['P'] = { 0x00, 0x00, 0x7C, 0x66, 0x66, 0x66, 0x7C, 0x60, 0x60, 0x60,
		  0x60, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['Q'] = { 0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C,
		  0x0E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['R'] = { 0x00, 0x00, 0x7C, 0x66, 0x66, 0x66, 0x7C, 0x78, 0x6C, 0x66,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['S'] = { 0x00, 0x00, 0x3C, 0x66, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['T'] = { 0x00, 0x00, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['U'] = { 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['V'] = { 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['W'] = { 0x00, 0x00, 0x63, 0x63, 0x63, 0x63, 0x6B, 0x7F, 0x77, 0x63,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['X'] = { 0x00, 0x00, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x3C, 0x66, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['Y'] = { 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['Z'] = { 0x00, 0x00, 0x7E, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x60, 0x60,
		  0x7E, 0x00, 0x00, 0x00, 0x00, 0x00 },

	// Lowercase letters
	['a'] = { 0x00, 0x00, 0x00, 0x00, 0x3C, 0x06, 0x3E, 0x66, 0x66, 0x66,
		  0x3E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['b'] = { 0x00, 0x00, 0x60, 0x60, 0x7C, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x7C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['c'] = { 0x00, 0x00, 0x00, 0x00, 0x3C, 0x66, 0x60, 0x60, 0x60, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['d'] = { 0x00, 0x00, 0x06, 0x06, 0x3E, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x3E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['e'] = { 0x00, 0x00, 0x00, 0x00, 0x3C, 0x66, 0x7E, 0x60, 0x60, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['f'] = { 0x00, 0x00, 0x1C, 0x36, 0x30, 0x30, 0x7C, 0x30, 0x30, 0x30,
		  0x30, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['g'] = { 0x00, 0x00, 0x00, 0x00, 0x3E, 0x66, 0x66, 0x66, 0x3E, 0x06,
		  0x66, 0x3C, 0x00, 0x00, 0x00, 0x00 },
	['h'] = { 0x00, 0x00, 0x60, 0x60, 0x7C, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['i'] = { 0x00, 0x00, 0x18, 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['j'] = { 0x00, 0x00, 0x06, 0x00, 0x0E, 0x06, 0x06, 0x06, 0x06, 0x66,
		  0x66, 0x3C, 0x00, 0x00, 0x00, 0x00 },
	['k'] = { 0x00, 0x00, 0x60, 0x60, 0x66, 0x6C, 0x78, 0x78, 0x6C, 0x66,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['l'] = { 0x00, 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['m'] = { 0x00, 0x00, 0x00, 0x00, 0x66, 0x7F, 0x7F, 0x6B, 0x63, 0x63,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['n'] = { 0x00, 0x00, 0x00, 0x00, 0x7C, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['o'] = { 0x00, 0x00, 0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['p'] = { 0x00, 0x00, 0x00, 0x00, 0x7C, 0x66, 0x66, 0x66, 0x7C, 0x60,
		  0x60, 0x60, 0x00, 0x00, 0x00, 0x00 },
	['q'] = { 0x00, 0x00, 0x00, 0x00, 0x3E, 0x66, 0x66, 0x66, 0x3E, 0x06,
		  0x06, 0x06, 0x00, 0x00, 0x00, 0x00 },
	['r'] = { 0x00, 0x00, 0x00, 0x00, 0x7C, 0x66, 0x60, 0x60, 0x60, 0x60,
		  0x60, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['s'] = { 0x00, 0x00, 0x00, 0x00, 0x3E, 0x60, 0x60, 0x3C, 0x06, 0x06,
		  0x7C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['t'] = { 0x00, 0x00, 0x18, 0x18, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x0E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['u'] = { 0x00, 0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66,
		  0x3E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['v'] = { 0x00, 0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['w'] = { 0x00, 0x00, 0x00, 0x00, 0x63, 0x63, 0x6B, 0x6B, 0x7F, 0x77,
		  0x63, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['x'] = { 0x00, 0x00, 0x00, 0x00, 0x66, 0x3C, 0x18, 0x18, 0x3C, 0x66,
		  0x66, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['y'] = { 0x00, 0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x3E, 0x06,
		  0x66, 0x3C, 0x00, 0x00, 0x00, 0x00 },
	['z'] = { 0x00, 0x00, 0x00, 0x00, 0x7E, 0x0C, 0x18, 0x30, 0x60, 0x60,
		  0x7E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	...
	['.'] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['!'] = { 0x00, 0x00, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['?'] = { 0x00, 0x00, 0x3C, 0x66, 0x06, 0x0C, 0x18, 0x18, 0x00, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	[':'] = { 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x18, 0x18,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	[';'] = { 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x18, 0x18,
		  0x30, 0x00, 0x00, 0x00, 0x00, 0x00 },
	...
	[')'] = { 0x00, 0x00, 0x30, 0x18, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x18,
		  0x30, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['@'] = { 0x00, 0x00, 0x3C, 0x66, 0x66, 0x6E, 0x6E, 0x60, 0x62, 0x66,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['#'] = { 0x00, 0x00, 0x36, 0x36, 0x7F, 0x36, 0x36, 0x36, 0x7F, 0x36,
		  0x36, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['$'] = { 0x00, 0x00, 0x0C, 0x3E, 0x6C, 0x68, 0x3E, 0x16, 0x36, 0x7C,
		  0x30, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['%'] = { 0x00, 0x00, 0x62, 0x66, 0x0C, 0x18, 0x30, 0x66, 0x46, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['^'] = { 0x00, 0x00, 0x10, 0x38, 0x6C, 0xC6, 0x00, 0x00, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['&'] = { 0x00, 0x00, 0x38, 0x6C, 0x6C, 0x38, 0x76, 0xDC, 0xCC, 0xCC,
	...
	['<'] = { 0x00, 0x00, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x30, 0x18, 0x0C,
		  0x06, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['>'] = { 0x00, 0x00, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x0C, 0x18, 0x30,
		  0x60, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['['] = { 0x00, 0x00, 0x3C, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	[']'] = { 0x00, 0x00, 0x3C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,
		  0x3C, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['{'] = { 0x00, 0x00, 0x0E, 0x18, 0x18, 0x18, 0x70, 0x18, 0x18, 0x18,
		  0x0E, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['}'] = { 0x00, 0x00, 0x70, 0x18, 0x18, 0x18, 0x0E, 0x18, 0x18, 0x18,
		  0x70, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['|'] = { 0x00, 0x00, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
		  0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['~'] = { 0x00, 0x00, 0x00, 0x00, 0x76, 0xDC, 0x00, 0x00, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['`'] = { 0x00, 0x00, 0x30, 0x18, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['\''] = { 0x00, 0x00, 0x18, 0x18, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00,
		   0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	['"'] = { 0x00, 0x00, 0x66, 0x66, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00,
		  0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
};
...
{
	WARN_ON(vga_color >=
		16); /* VGA color index >= 16 is out of palette range */
...
static inline uint32_t sb_capacity(void)
{
	return CONSOLE_SCROLLBACK_LINES;
}

static inline uint32_t sb_visible_lines(void)
{
	return max_rows;
}
...
static console_line_t *sb_current_line(void)
{
	return &g_sb.lines[g_sb.head];
}
...
static void sb_new_line(void)
{
	...
	if (g_sb.total_filled_lines < 0xFFFFFFFFu)
		g_sb.total_filled_lines++;
	g_prompt_guard_len = 0;
	// Clear the new line
	...
	if (g_sb.at_bottom) {
		...
		if (g_sb.visible_lines <= eff) {
			uint32_t max_vp = eff > g_sb.visible_lines ?
						  (eff - g_sb.visible_lines) :
						  0;
...
static void sb_append_char(uint32_t c)
{
	...
	if (c == '\t') {
		...
		uint16_t next = (uint16_t)(((line->write_pos + 8) & ~7) -
					   line->write_pos);
		for (uint16_t i = 0;
		     i < next && line->write_pos < CONSOLE_MAX_LINE_LENGTH - 1;
		     ++i) {
...
static void console_render_view(void)
{
	...
	uint32_t text_w =
		(fb_info->horizontal_resolution > sb_total_w) ?
			(fb_info->horizontal_resolution - sb_total_w) :
			0;
	...
	for (uint32_t row = 0; row < rows; ++row) {
		...
		uint32_t ring_idx =
			(g_sb.total_filled_lines <= sb_capacity()) ?
				logical_idx :
		...
		// Draw characters
		uint32_t cols =
			(line->length < max_cols) ? line->length : max_cols;
		for (uint32_t col = 0; col < cols; ++col) {
			uint8_t ch_fg = line->fg_attrs[col];
			uint8_t ch_bg = line->bg_attrs[col];
			draw_char(line->text[col], col * CHAR_WIDTH, y,
				  vga_to_rgb(ch_fg), vga_to_rgb(ch_bg));
		}
		...
		if (cols < max_cols) {
			...
			if (w)
				fb_fill_rect(px, y, w, CHAR_HEIGHT, bg_color);
		}
	}
	// Mark dirty
	if (text_w && text_h)
		fb_mark_dirty(0, 0, text_w - 1, text_h - 1);
}
...
static void set_pixel(uint32_t x, uint32_t y, uint32_t color)
{
	if (!fb_info || !fb_info->framebuffer_base)
		return;
	if (x >= fb_info->horizontal_resolution ||
	    y >= fb_info->vertical_resolution)
		return;
...
static void draw_cursor_at(uint32_t x, uint32_t y, uint8_t show)
{
	...
	if (show) {
		...
		if (cursor_pixels_saved &&
			...
			for (uint32_t row2 = 0; row2 < h; row2++) {
				set_pixel(old_px, old_py + row2,
					  cursor_saved_pixels
						  [row2 * CURSOR_SAVE_W + 0]);
				set_pixel(old_px + 1, old_py + row2,
					  cursor_saved_pixels
						  [row2 * CURSOR_SAVE_W + 1]);
			}
		...
		if (cursor_pixels_saved && cursor_saved_x == x &&
		    cursor_saved_y == y)
			return;
				...
				if (fb_opt) {
					...
					uint32_t *framebuffer =
						(uint32_t *)fb_info
							->framebuffer_base;
					uint32_t offset =
						py * fb_info->pixels_per_scanline +
						px;
		...
		if (cursor_pixels_saved && cursor_saved_x == x &&
		    cursor_saved_y == y) {
			for (uint32_t row = 0; row < h; row++) {
				for (uint32_t col = 0; col < CURSOR_SAVE_W;
				     col++) {
		      ...
		      uint32_t bg_clr)
{
	...
	fb_double_buffer_t *fb_opt = get_fb_double_buffer();
	if (fb_opt) {
		fb_draw_char_fast(x, y, glyph, font_w, font_h, bpr, fg_clr,
				  bg_clr);
		return;
	}
...
void console_init(framebuffer_info_t *fb)
{
	BUG_ON(fb == NULL);
	WARN_ON_ONCE(
		fb->horizontal_resolution == 0 ||
		fb->vertical_resolution ==
			0); /* console init with zero framebuffer dimensions */
...
void console_erase_display(int mode)
{
	...
	if (mode == 2) {
		...
		if (below_y < scr_h)
			fb_fill_rect(0, below_y, text_w, scr_h - below_y,
				     bg_color);
	} else if (mode == 1) {
...
void console_scroll_region_up(int n, int top, int bot)
{
	...
	if (move_rows > 0) {
		fb_copy_rect(0, (uint32_t)(top * CHAR_HEIGHT), 0,
			     (uint32_t)((top + n) * CHAR_HEIGHT), text_w,
			     move_rows * CHAR_HEIGHT);
	}
...
void console_scroll_region_down(int n, int top, int bot)
{
	...
	uint32_t move_rows = (uint32_t)(region_rows - n);
	if (move_rows > 0) {
		fb_copy_rect(0, (uint32_t)((top + n) * CHAR_HEIGHT), 0,
			     (uint32_t)(top * CHAR_HEIGHT), text_w,
			     move_rows * CHAR_HEIGHT);
	}
...
void console_insert_lines(int n, int top, int bot)
{
	if (n <= 0)
		return;
	if ((int)cursor_y < top || (int)cursor_y > bot)
		return;
...
void console_insert_chars(int n)
{
	...
	if (n <= 0)
		return;
	if (n > (int)(max_cols - cursor_x))
		n = (int)(max_cols - cursor_x);
	...
	if (x + shift < text_w) {
		fb_copy_rect(x + shift, y, x, y, text_w - x - shift,
			     CHAR_HEIGHT);
	}
...
void console_delete_chars(int n)
{
	...
	uint32_t shift = (uint32_t)n * CHAR_WIDTH;
	if (x + shift < text_w) {
		fb_copy_rect(x, y, x + shift, y, text_w - x - shift,
			     CHAR_HEIGHT);
	}
...
static void console_scroll_up(void)
{
	...
	if (g_region_top >= 0 && g_region_bot >= 0 &&
		...
		int region_rows = bot - top + 1;
		if (region_rows > 1) {
			fb_copy_rect(0, (uint32_t)(top * (int)CHAR_HEIGHT), 0,
				     (uint32_t)((top + 1) * (int)CHAR_HEIGHT),
				     text_w,
				     (uint32_t)(region_rows - 1) * CHAR_HEIGHT);
		}
		fb_fill_rect(0, (uint32_t)(bot * (int)CHAR_HEIGHT), text_w,
	...
	fb_double_buffer_t *fb_opt = get_fb_double_buffer();
	if (fb_opt) {
		fb_copy_rect(0, 0, 0, scroll_lines, text_area_width,
			     height - scroll_lines);
		fb_fill_rect(0, height - scroll_lines, text_area_width,
			     scroll_lines, bg_color);
	} else {
		uint32_t *framebuffer = (uint32_t *)fb_info->framebuffer_base;
		uint32_t pixels_per_line = fb_info->pixels_per_scanline;
		for (uint32_t y = scroll_lines; y < height; y++) {
			uint32_t *src_line = &framebuffer[y * pixels_per_line];
			uint32_t *dst_line = &framebuffer[(y - scroll_lines) *
							  pixels_per_line];
			kmemcpy(dst_line, src_line,
				text_area_width * sizeof(uint32_t));
		}
	...
	if (c == '\t') {
		...
		if (g_sb.at_bottom) {
			...
			for (uint32_t i = 0; i < spaces; ++i) {
				...
				draw_char(' ', cursor_x * CHAR_WIDTH,
					  cursor_y * CHAR_HEIGHT, fg_color,
					  bg_color);
...
void console_restore_alt_screen(uint32_t saved_total)
{
	...
	if (saved_total <= g_sb.total_filled_lines) {
		uint32_t lines_to_remove =
			g_sb.total_filled_lines - saved_total;
		if (lines_to_remove > cap)
			lines_to_remove = cap;
...
void console_cursor_update(void)
{
	...
	if (freq < 10)
		freq = 100; /* guard against pre-calibration zero */
...
void console_handle_mouse_event(int x, int y, uint8_t left_pressed)
{
	...
	if (left_pressed) {
		...
		if (!g_sb.dragging_thumb &&
		    scrollbar_hit_thumb(sb, (uint32_t)x, (uint32_t)y)) {
		...
		if ((uint32_t)x >= sb->x && (uint32_t)x < sb->x + sb->width &&
		    (uint32_t)y >= track_top && (uint32_t)y < track_bottom) {
			// Determine page size and direction relative to thumb
			uint32_t page = (g_sb.visible_lines > 1) ?
						(g_sb.visible_lines - 1) :
						g_sb.visible_lines;
			if ((uint32_t)y < sb->thumb_y) {
				// Page up
				uint32_t new_top =
					(g_sb.viewport_top > page) ?
						(g_sb.viewport_top - page) :
						0;
				console_set_viewport_top(new_top);
			} else if ((uint32_t)y >=
				   sb->thumb_y + sb->thumb_height) {
				// Page down
				uint32_t eff = sb_effective_total();
				uint32_t max_vp =
					(eff > g_sb.visible_lines) ?
	...
	if (g_sb.dragging_thumb) {
		...
		if (track_range > 0 && max_vp > 0) {
			...
			int d_view = (int)((int64_t)dy * (int64_t)max_vp /
					   (int64_t)track_range);
			int new_vp = (int)g_sb.drag_start_viewport + d_view;
			if (new_vp < 0)
				new_vp = 0;
			if (new_vp > (int)max_vp)
				new_vp = (int)max_vp;
