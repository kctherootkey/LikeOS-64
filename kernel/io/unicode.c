// Unicode character width table for the console.
//
...
// Occupies no cell: combining marks and format characters
static const struct urange uni_w0[] = {
...
// Occupies two cells: East Asian Wide and Fullwidth
static const struct urange uni_w2[] = {
