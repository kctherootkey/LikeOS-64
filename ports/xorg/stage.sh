...
# double-clicked file opens with.  xterm and NetSurf are the two programs here
# that other software needs to be able to NAME -- libfm looks for
# xterm.desktop when asked to open a terminal, and text/html has to resolve to
# something.
#
