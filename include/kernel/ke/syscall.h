...
#define SYS_NET_GETINFO \
	371 // Get network info (ARP table, route table, connections)
...
typedef struct k_sysinfo {
	...
	unsigned long
		loads[3]; // 1, 5, 15 minute load averages (fixed-point << 16)
