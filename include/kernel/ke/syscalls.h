...
int64_t sys_semget(uint64_t key, uint64_t nsems, uint64_t semflg);
int64_t sys_semop(uint64_t semid, uint64_t sops, uint64_t nsops);
int64_t sys_semctl(uint64_t semid, uint64_t semnum, uint64_t cmd, uint64_t arg);
