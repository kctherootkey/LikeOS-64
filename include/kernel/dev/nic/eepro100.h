...
// ============================================================================
#define EEPRO100_SCB_STATUS \
	0x00 // 8-bit RO  — CU/RU state byte (CUS bits 7:6, RUS bits 5:2)
#define EEPRO100_SCB_ACK \
	0x01 // 8-bit RW  — STAT/ACK byte (CX/FR/CNA/RNR/MDI/SWI); read to see, write same bits to clear
